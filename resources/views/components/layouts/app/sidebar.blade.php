    ...
    <div class="h-16 sm:h-20 flex items-center px-4 sm:px-6 border-b border-slate-100 dark:border-slate-800/50 relative overflow-hidden">
        ...
        <a href="{{ route('dashboard') }}" class="relative flex items-center gap-3 group w-full">
            <div class="relative flex-shrink-0">
                <img src="{{ asset('Lambang_Polda_Banten.png') }}" alt="Polda Banten" class="w-10 h-10 sm:w-12 sm:h-12 object-contain" />
            </div>
            <div class="flex flex-col flex-1 min-w-0">
                ...
                <span class="text-[10px] sm:text-[11px] font-medium text-slate-500 dark:text-slate-400 uppercase tracking-widest mt-0.5">Polda Banten</span>
            </div>
        </a>
    </div>
